...
Presently, Rich integrates with Formtastic 2 and regular Rails forms.
...
Since Active Admin actually uses Formtastic, you can use it with Rich out of the box. In your model configuration file, set up your form like this. Make sure you use a recent version of Active Admin, that supports Formtastic 2 (which Rich requires).
