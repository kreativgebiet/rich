...
You might use this in a relation like this in ActiveAdmin:
  ...
  form do |f|
    ...
    f.has_many :assets do |asset_form|
      asset_form.input :rich_file_id, :as => :rich_picker, :config => {:style => 'width: 400px !important;', :allowed_styles => [:original], :hidden_input => true, :placeholder_image => image_path('placeholder.png')}
    end
    f.buttons
  end
