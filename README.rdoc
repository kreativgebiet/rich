...
Presently, Rich integrates with Active Admin, Rails Admin and vanilla Formtastic (versions 1 and 2). Uploaded files can be stored on the filesystem, or on S3.
...
Pass the config option <tt>:preview_width => '100px'</tt> to specify the size of the image you want to preview, otherwise the full size version of the image you pick will be shown.
