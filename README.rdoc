...
{<img src="https://github.com/bastiaanterhorst/rich/raw/upload-other-files/app/assets/images/rich/rich.png" />}[Rich] Rich is an opinionated implementation of CKEditor for Rails 3.1. It includes a stripped down toolbar, simplified dialogs and a custom file manager.
