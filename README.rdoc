...
Support for Rails Admin is very new and should be considered fragile. Per-editor configuration is not supported. However, you can globally customize your editors through the Rich initializer.

To use Rich in your RA forms, first add the following lines to your <tt>/config/initializers/rails_admin.rb</tt>.

  require 'rich/rails_admin'
  RailsAdmin::Config::Fields::Types::register(Rich::RichRailsAdmin::RichEditor)
